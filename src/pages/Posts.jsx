...
const AllPosts = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`https://code-share-server-phi.vercel.app/?search=${searchQuery}`);
    ...
    const deletePost = async () => {
        try {
            await axios.delete(`https://code-share-server-phi.vercel.app/${selectedPost._id}`);
